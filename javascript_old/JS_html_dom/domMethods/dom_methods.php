...
<button class="accordion">insertAfter()</button>
<div class="panel">
   <?php include'../../JS_html_dom/domMethods/insertAfter.php'?>
</div>

<button class="accordion">insertBefore()</button>
<div class="panel">
   <?php include'../../JS_html_dom/domMethods/insertBefore.php'?>
</div>
